...
urlpatterns = [
    ...
    path("folders/<int:folder_id>/terms/create/", views.term_create, name="term_create"),
    # 単語編集/削除/状態変更（← pk だけ）
    path("terms/<int:pk>/edit/", views.term_edit, name="term_edit"),
    path("terms/<int:pk>/delete/", views.term_delete, name="term_delete"),
    path("terms/<int:pk>/status/<str:next_status>/",views.term_toggle_status,name="term_toggle_status",),
    path("folders/<int:pk>/delete/", views.folder_delete, name="folder_delete"),
]
